...
//			}
			...
			FontMetrics matrics = getFontMetrics(g.getFont());		// for center the content
	...
	public void checkCollisions() {
		...
		// check if body is colide with his body 
		for(int i = bodyParts;i>0;i--) {
			if((x[0] == x[i]) && (y[0] == y[i])) {
				running = false;
			}
	...
	public void gameOver(Graphics g) {
		...
		g.setColor(Color.red);
		g.setFont(new Font("MV Boli",Font.BOLD,40));
		FontMetrics matrics1 = getFontMetrics(g.getFont());		// for center the content
